package com.dyonovan.repairchests.client.screen;
...
@OnlyIn(Dist.CLIENT)
public class RepairChestScreen extends AbstractContainerScreen<RepairChestMenu> implements MenuAccess<RepairChestMenu> {
    ...
    public RepairChestScreen(RepairChestMenu container, Inventory playerInventory, Component title) {
